...
all_points = [
    ("gradient", "S3TC", 6.0, 786432, 38.26092956),
    ...
    ("bricks", "S3TC", 6.0, 786432, 36.62231189),
    ...
    ("clouds", "S3TC", 6.0, 786432, 37.50078965),
    ...
    ("car", "S3TC", 6.0, 786432, 28.77932968),
    ...
    ("moon", "S3TC", 6.0, 786432, 28.7939358),
    ...
    ("night", "S3TC", 6.0, 786432, 20.6324802),
